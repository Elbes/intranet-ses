...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
       <iframe width="100%" height="600" src="http://intranet/gabinete/_layouts/15/start.aspx#/SitePages/P%C3%A1gina%20Inicial.aspx"></iframe>
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-8">
                    <p>Notícias Notícias Notícias Notícias</p>
                </div>
                <div class="col-md-4">
                    <a class="btn btn-lg btn-default btn-block" href="#">Topo</a>
                </div>
            </div>
        </div>
